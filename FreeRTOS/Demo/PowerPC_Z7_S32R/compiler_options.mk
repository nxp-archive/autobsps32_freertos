...
ASFLAGS  :=  -g --gdwarf-sections --gstabs+ -L -mregnames -mvle \
             ...
             -I$(shell cygpath -m -i $(CRT_DIR))/specific/$(PLATFORM)/inc \
...
LDFLAGS :=  --sysroot=$(shell cygpath -m -i $(COMPILER_LIBS)) -mcpu=e200z7 -mfpu=sp_full -Xlinker -Map=$(shell cygpath -m -i $(OUT_ROOT)/$(TEST_NAME).map) \
             -nostartfiles -T$(shell cygpath -m -i $(CRT_DIR))/specific/$(PLATFORM)/src_ld/flash_$(PLATFORM).ld -static -Xlinker --gc-sections -Xlinker --print-gc-sections
